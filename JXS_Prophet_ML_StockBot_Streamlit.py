    ...
    if st.button('Predict'):
        with st.spinner('Fetching data and making predictions...'):
            try:
                ...
                if df.empty:
                    st.error("No data found for the ticker. Please check the ticker symbol or try again later if you were rate limited.")
                else:
                ...
                if "Rate limited" in str(e) or "Too Many Requests" in str(e):
                    st.error("Yahoo Finance rate limit exceeded. Please wait a few minutes before trying again.")
                else:
